...
func initP256() {
	p256 = new(Curve)
	p256.P, _ = new(big.Int).SetString("fffffffffffcf0cd46e5f25eee71a49f0cdc65fb12980a82d3292ddbaed33013", 16)
	p256.N, _ = new(big.Int).SetString("fffffffffffcf0cd46e5f25eee71a49e0cdc65fb1299921af62d536cd10b500d", 16)
	p256.B, _ = new(big.Int).SetString("05", 16)
	p256.Gx, _ = new(big.Int).SetString("ddc0cc3a0311f5f3557ca7e4cea94c64b04811bc4e11902f87f0895e73954558", 16)
	p256.Gy, _ = new(big.Int).SetString("dde7d9b8a594b77474e9e61c45b3d845243098e5b20d9af90ca0d43e635e4a33", 16)
	p256.BitSize = 256
}
